...
agora = datetime.datetime.now()# Obtém a data e hora atuais

data = f"Data: {agora.day:02d}/{agora.month:02d}/{agora.year}"# Formata a data e a hora usando f-strings
hora = f"Hora: {agora.hour:02d}:{agora.minute:02d}"# Formata a hora usando f strings
